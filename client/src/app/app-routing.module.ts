...
const routes: Routes = [
  ...
  { path: 'my-class-group/:id', loadChildren: './pages/my-class-group/my-class-group.module#MyClassGroupPageModule' },
  ...
  { path: 'transfer-class-group/:id', loadChildren: './pages/transfer-class-group/transfer-class-group.module#TransferClassGroupPageModule' },
